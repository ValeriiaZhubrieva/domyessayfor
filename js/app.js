(() => {
    ...
    function initSliders() {
        const swiperParent = document.querySelectorAll(".slider");
        if (swiperParent) swiperParent.forEach((parent => {
            const swiperNextBtn = parent.querySelector(".swiper-button-next");
            const swiperPrevBtn = parent.querySelector(".swiper-button-prev");
            const swiperPagination = parent.querySelector(".swiper-pagination");
            new Swiper(parent, {
    ...
    const tabsDropdownButton = document.querySelector(".tabs-services__button");
    const tabsDropdown = document.querySelector(".tabs-services__dropdown");
    const tabsTitles = document.querySelectorAll(".tabs-services__title");
    tabsDropdownButton.addEventListener("click", (() => {
        tabsDropdown.classList.toggle("open-dropdown-tabs");
    }));
    tabsTitles.forEach((item => {
        item.addEventListener("click", (() => {
            tabsDropdown.classList.remove("open-dropdown-tabs");
            tabsDropdownButton.innerHTML = item.innerHTML;
        }));
    }));
    menuInit();
    tabs();
